...
instance Print Stmt where
  prt i e = case e of
   ...
   SPrintFun id -> prPrec i 0 (concatD [doc (showString "print") , doc (showString "<--") , doc (showString "(") , prt 0 id , doc (showString "(") , doc (showString ")") , doc (showString ")")])
   SPrintFunExp id exp -> prPrec i 0 (concatD [doc (showString "print") , doc (showString "<--") , doc (showString "(") , prt 0 id , doc (showString "(") , prt 0 exp , doc (showString ")") , doc (showString ")")])
...
instance Print BExp where
  prt i e = case e of
   ...
   BStringRel8 id0 n id -> prPrec i 2 (concatD [prt 0 id0 , doc (showString "[") , prt 0 n , doc (showString "]") , doc (showString ".equals") , doc (showString "(") , prt 0 id , doc (showString ")")])
