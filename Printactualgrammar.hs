...
instance Print Stmt where
  prt i e = case e of
   ...
   SProcAttr id procc -> prPrec i 0 (concatD [prt 0 id , doc (showString ":=") , prt 0 procc])
...
instance Print Procc where
  prt i e = case e of
   ProcCall id -> prPrec i 0 (concatD [prt 0 id , doc (showString "(") , doc (showString ")") , doc (showString ";")])
   ProcCallId id0 id -> prPrec i 0 (concatD [prt 0 id0 , doc (showString "(") , prt 0 id , doc (showString ")") , doc (showString ";")])
   ...
   ProcCallFuncSyg id funcdeclline -> prPrec i 0 (concatD [prt 0 id , doc (showString "(") , prt 0 funcdeclline , doc (showString ")") , doc (showString ";")])
...
instance Print Exp where
  prt i e = case e of
   ...
   EFunIdArray id0 id n -> prPrec i 2 (concatD [prt 0 id0 , doc (showString "(") , prt 0 id , doc (showString "[") , prt 0 n , doc (showString "]") , doc (showString ")")])
   EFunIdWholeArray id0 id -> prPrec i 2 (concatD [prt 0 id0 , doc (showString "(") , prt 0 id , doc (showString ")")])
...
instance Print Type where
  prt i e = case e of
   ...
   TRecord vardeclarationlines -> prPrec i 0 (concatD [doc (showString "Record") , prt 0 vardeclarationlines , doc (showString "RecEnd")])
