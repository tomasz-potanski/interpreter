...
typecheckFile (Programm programNameHeader (Blockk variableDeclaration procDecl stmts)) = interpretStmt stmts (prepareFunctions2 procDecl (declareNewVariables variableDeclaration (M.empty, M.empty)))
